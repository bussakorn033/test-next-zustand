...
import { OnClickCellParams, Pagination, TableColumn } from '@/shared-components/Table/Table.types';
...
const useDashboard = () => {
	...
	const [isShowModalCreateContract, setIsShowModalCreateContract] = useState<boolean>(false);
				...
				const mapping: Record<string, React.ReactNode> = {
					...
					view: (
						<TableActionButton
							...
							$isDisabled={!contract.snapshot.message_button[0]}
						/>
					),
					history: (
						<TableActionButton
							...
							onClickValue={onClickValue}
							$isDisabled={!contract.snapshot.message_button[1]}
						/>
					),
					trash: (
						<TableActionButton
							...
							onClickValue={onClickValue}
							$isDisabled={!contract.snapshot.message_button[2]}
						/>
					)
				};
