...
interface Contract {
  ...
  ecm_doc_id: string;
  history_log: Array<{ contract_status_code: string; updated_by_id: string; update_date: number }>;
...
const TableActionButton = ({
  ...
  return (
    <Button
      ...
      colorIcon={$isDisabled ? '--color-neutral-grey-lighter' : '--color-primary'}
      disabled={$isDisabled}
    />
  );
};

const useModalCreateContract = () => {
  ...
  const headerKeys: TableColumn[] = useMemo(
    () => [
      {
        key: 'rm_no',
        value: t('dashboard_modal_table_header_row1'),
        isSort: false,
        sortBy: undefined,
        width: '175px',
        flex: undefined,
      ...
      {
        key: 'id_card',
        value: t('dashboard_modal_table_header_row2'),
        isSort: false,
        sortBy: undefined,
        width: '175px',
        // $minWidth: '175px',
      ...
      {
        key: 'full_name',
        value: t('dashboard_modal_table_header_row3'),
        isSort: false,
        sortBy: undefined,
        width: '175px',
        flex: undefined,
      ...
      {
        key: 'status',
        value: t('dashboard_modal_table_header_row4'),
        isSort: false,
        sortBy: undefined,
        width: '175px',
        flex: undefined,
    ...
    return (
      dashboardData?.data?.contract_lists?.map((contract: Contract, rowIndex: number) => {
        const mapping: Record<string, React.ReactNode> = {
          rm_no: contract.document_running,
          ...
          selected: (
            <Button variant='ghost-primary' fontWeight='--font-weight-regular'>
              {t('dashboard_modal_table_body_select')}
            </Button>
          )
        };
...
export default useModalCreateContract;
