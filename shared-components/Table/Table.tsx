													...
													{item.map((col, colIndex) => {
														...
														return (
															...
															>
																...
																>
																	{console.log(`---- --------------------------------------------`)}
																	{console.log(`---- Table.tsx:204 {item.map cell:`, cell)}
																	{console.log(`---- --------------------------------------------`)}
					...
					{!isPaginationDisabled && (
						...
						>
							...
							<Box direction='row' alignItems='center' gap={8}>
								...
								<Box direction='row' alignItems='center' gap={8}>
									<TextStyle variant='labelSmallBold' color='--color-primary' alignContent='center'>
										{limit}
									</TextStyle>
									<Button
										onClick={() => {
										...
										borderRadius='round'
									>
										<Icon icon='arrow_down' width={16} height={16} color='--color-primary' />
									</Button>
									<Box direction='row' alignItems='center' gap={8} borderWidth={1} borderRadius='xl'>
										<Box
											direction='column'
											alignItems='center'
											gap={8}
